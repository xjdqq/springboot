package com.how2java.springboot.shiro;

import com.how2java.springboot.biz.shiro.UsersAuthBiz;
import com.how2java.springboot.shiro.realms.MyShiroRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager){
        ...
        filterChainDefinitionMap.put("/listProduct","user,perms[5],roles[1]");
        ...
        // 登录成功后要跳转的链接
        shiroFilterFactoryBean.setSuccessUrl("/listProduct");
        // 未授权界面;
